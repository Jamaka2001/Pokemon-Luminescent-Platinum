...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Arbok: {types: ['Poison'], bs: {hp: 60, at: 110, df: 70, sp: 80, sl: 80}, weightkg: 65},
  Arcanine: {
    types: ['Fire'],
  ...
  Articuno: {
    types: ['Ice', 'Flying'],
    bs: {hp: 90, at: 75, df: 100, sp: 85, sl: 95},
    weightkg: 55.4,
  },
  Beedrill: {
    types: ['Bug', 'Poison'],
  ...
  Goldeen: {
    types: ['Water'],
    bs: {hp: 45, at: 67, df: 60, sp: 73, sl: 50},
    weightkg: 15,
    nfe: true,
  },
  ...
  Mankey: {
    types: ['Fighting'],
    bs: {hp: 40, at: 80, df: 35, sp: 80, sl: 35},
    weightkg: 28,
    nfe: true,
  },
  ...
  Pidgeot: {
    types: ['Normal', 'Flying'],
    bs: {hp: 83, at: 60, df: 70, sp: 102, sl: 70},
    weightkg: 39.5,
  },
  Pidgeotto: {
    types: ['Normal', 'Flying'],
  ...
  Primeape: {
    types: ['Fighting'],
    bs: {hp: 65, at: 105, df: 60, sp: 105, sl: 60},
    weightkg: 32,
  },
  Psyduck: {
    types: ['Water'],
...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  'Farfetch\u2019d': {types: ['Fighting', 'Flying'], bs: {sa: 55, sd: 60}},
  ...
  Goldeen: {bs: {sa: 62, sd: 40}},
  Golduck: {types: ['Water', 'Psychic'], bs: {sa: 95, sd: 80}},
  ...
  Ninetales: {types: ['Fire', 'Fairy'], bs: {sa: 81, sd: 100}},
  ...
  Granbull: {
    types: ['Normal'],
    bs: {hp: 90, at: 120, df: 75, sa: 60, sd: 75, sp: 45},
    weightkg: 48.7,
  },
  Heracross: {
    types: ['Bug', 'Fighting'],
  ...
  Houndoom: {
    types: ['Dark', 'Fire'],
    bs: {hp: 75, at: 100, df: 50, sa: 110, sd: 80, sp: 95},
    weightkg: 35,
  },
  Houndour: {
    types: ['Dark', 'Fire'],
  ...
  Jumpluff: {
    types: ['Grass', 'Flying'],
    bs: {hp: 75, at: 55, df: 70, sa: 85, sd: 85, sp: 110},
    weightkg: 3,
  },
  Kingdra: {
    types: ['Water', 'Dragon'],
  ...
  Lanturn: {
    types: ['Water', 'Electric'],
    bs: {hp: 125, at: 70, df: 58, sa: 76, sd: 76, sp: 67},
    weightkg: 22.5,
  },
  Larvitar: {
    types: ['Rock', 'Ground'],
  ...
  Magcargo: {
    types: ['Fire', 'Rock'],
    bs: {hp: 50, at: 50, df: 150, sa: 110, sd: 100, sp: 30},
    weightkg: 55,
  },
  Mantine: {
    types: ['Water', 'Flying'],
    bs: {hp: 65, at: 40, df: 70, sa: 90, sd: 140, sp: 70},
    weightkg: 220,
  },
  Mareep: {
    types: ['Electric'],
  ...
  Noctowl: {
    types: ['Psychic', 'Flying'],
    bs: {hp: 100, at: 40, df: 50, sa: 76, sd: 116, sp: 60},
    weightkg: 40.8,
  },
  Octillery: {
    types: ['Water'],
  ...
  Qwilfish: {
    types: ['Water', 'Poison'],
    bs: {hp: 65, at: 95, df: 75, sa: 45, sd: 65, sp: 95},
    weightkg: 3.9,
  },
  Raikou: {
    types: ['Electric'],
  ...
  Sentret: {
    types: ['Normal'],
    bs: {hp: 45, at: 45, df: 35, sa: 35, sd: 45, sp: 20},
    weightkg: 6,
    nfe: true,
  },
  Shuckle: {
  ...
  Stantler: {
    types: ['Normal'],
    bs: {hp: 73, at: 105, df: 62, sa: 75, sd: 65, sp: 85},
    weightkg: 71.2,
  },
  Steelix: {
    types: ['Steel', 'Ground'],
...
const ADV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Absol: {
    types: ['Dark'],
    bs: {hp: 75, at: 130, df: 60, sa: 85, sd: 60, sp: 95},
    weightkg: 47,
  ...
  Banette: {
    types: ['Ghost'],
    bs: {hp: 64, at: 125, df: 65, sa: 93, sd: 63, sp: 70},
    weightkg: 12.5,
  ...
  Beautifly: {
    types: ['Bug', 'Flying'],
    bs: {hp: 60, at: 70, df: 60, sa: 90, sd: 60, sp: 75},
    weightkg: 28.4,
    abilities: {0: 'Swarm'},
  },
  Beldum: {
  ...
  Chimecho: {
    types: ['Psychic'],
    bs: {hp: 65, at: 40, df: 70, sa: 110, sd: 100, sp: 65},
    weightkg: 1,
    abilities: {0: 'Levitate'},
  },
  Clamperl: {
  ...
  Delcatty: {
    types: ['Normal'],
    bs: {hp: 70, at: 75, df: 80, sa: 75, sd: 80, sp: 95},
    weightkg: 32.6,
  ...
  Huntail: {
    types: ['Water'],
    bs: {hp: 55, at: 94, df: 105, sa: 75, sd: 104, sp: 52},
    weightkg: 27,
    abilities: {0: 'Swift Swim'},
  },
  Illumise: {
  ...
  Linoone: {
    types: ['Normal'],
    bs: {hp: 85, at: 85, df: 70, sa: 50, sd: 70, sp: 110},
    weightkg: 32.5,
    abilities: {0: 'Pickup'},
  },
  Lombre: {
  ...
  Lunatone: {
    types: ['Rock', 'Psychic'],
    bs: {hp: 70, at: 55, df: 65, sa: 100, sd: 85, sp: 70},
    weightkg: 168,
    abilities: {0: 'Levitate'},
    gender: 'N',
  },
  ...
  Masquerain: {
    types: ['Bug', 'Flying'],
    bs: {hp: 70, at: 50, df: 50, sa: 80, sd: 100, sp: 60},
    weightkg: 3.6,
    abilities: {0: 'Intimidate'},
  },
  Mawile: {
    types: ['Steel'],
    bs: {hp: 60, at: 95, df: 115, sa: 55, sd: 85, sp: 50},
    weightkg: 11.5,
    abilities: {0: 'Hyper Cutter'},
  },
  Medicham: {
  ...
  Mightyena: {
    types: ['Dark'],
    bs: {hp: 70, at: 110, df: 70, sa: 60, sd: 60, sp: 100},
    weightkg: 37,
    abilities: {0: 'Intimidate'},
  },
  Milotic: {
  ...
  Minun: {
    types: ['Electric'],
    bs: {hp: 60, at: 85, df: 50, sa: 50, sd: 95, sp: 110},
    weightkg: 4.2,
    abilities: {0: 'Minus'},
  },
  Mudkip: {
  ...
  Pelipper: {
    types: ['Water', 'Flying'],
    bs: {hp: 60, at: 50, df: 110, sa: 85, sd: 80, sp: 65},
    weightkg: 28,
    abilities: {0: 'Keen Eye'},
  },
  Plusle: {
    types: ['Electric'],
    bs: {hp: 60, at: 85, df: 40, sa: 50, sd: 95, sp: 110},
    weightkg: 4.2,
    abilities: {0: 'Plus'},
  },
  Poochyena: {
  ...
  Sableye: {
    types: ['Dark', 'Ghost'],
    bs: {hp: 60, at: 75, df: 100, sa: 75, sd: 100, sp: 50},
    weightkg: 11,
    abilities: {0: 'Keen Eye'},
  },
  Salamence: {
  ...
  Sceptile: {
    types: ['Grass', 'Dragon'],
    bs: {hp: 70, at: 95, df: 65, sa: 105, sd: 80, sp: 120},
    weightkg: 52.2,
    abilities: {0: 'Overgrow'},
  },
  Sealeo: {
  ...
  Seviper: {
    types: ['Poison'],
    bs: {hp: 75, at: 115, df: 60, sa: 80, sd: 60, sp: 80},
    weightkg: 52.5,
    abilities: {0: 'Shed Skin'},
  },
  Sharpedo: {
  ...
  Solrock: {
    types: ['Rock', 'Psychic'],
    bs: {hp: 70, at: 100, df: 85, sa: 55, sd: 65, sp: 70},
    weightkg: 154,
    abilities: {0: 'Levitate'},
    gender: 'N',
  },
  ...
  Surskit: {
    types: ['Bug', 'Water'],
    bs: {hp: 40, at: 30, df: 30, sa: 55, sd: 52, sp: 65},
    weightkg: 1.7,
    nfe: true,
    abilities: {0: 'Swift Swim'},
  },
  ...
  Swellow: {
    types: ['Normal', 'Flying'],
    bs: {hp: 60, at: 90, df: 60, sa: 50, sd: 50, sp: 125},
    weightkg: 19.8,
    abilities: {0: 'Guts'},
  },
  Taillow: {
  ...
  Volbeat: {
    types: ['Bug'],
    bs: {hp: 65, at: 33, df: 55, sa: 107, sd: 75, sp: 100},
    weightkg: 17.7,
  ...
  Zangoose: {
    types: ['Normal'],
    bs: {hp: 75, at: 115, df: 60, sa: 60, sd: 60, sp: 100},
    weightkg: 40.3,
...
const DPP_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Ambipom: {
    types: ['Normal'],
    bs: {hp: 75, at: 100, df: 66, sa: 90, sd: 66, sp: 115},
    weightkg: 20.3,
  ...
  Bastiodon: {
    types: ['Rock', 'Steel'],
    bs: {hp: 60, at: 27, df: 168, sa: 77, sd: 138, sp: 30},
    weightkg: 149.5,
    abilities: {0: 'Sturdy'},
  },
  Bibarel: {
  ...
  Bronzong: {
    types: ['Steel', 'Psychic'],
    bs: {hp: 69, at: 89, df: 116, sa: 79, sd: 116, sp: 33},
    weightkg: 187,
    gender: 'N',
    abilities: {0: 'Levitate'},
  },
  ...
  Drapion: {
    types: ['Poison', 'Dark'],
    bs: {hp: 70, at: 90, df: 110, sa: 60, sd: 85, sp: 95},
    weightkg: 61.5,
    abilities: {0: 'Battle Armor'},
  },
  Drifblim: {
    types: ['Ghost', 'Flying'],
    bs: {hp: 150, at: 80, df: 54, sa: 90, sd: 54, sp: 80},
    weightkg: 15,
  ...
  Honchkrow: {
    types: ['Dark', 'Flying'],
    bs: {hp: 100, at: 125, df: 52, sa: 115, sd: 52, sp: 71},
    weightkg: 27.3,
    abilities: {0: 'Insomnia'},
  },
  Infernape: {
  ...
  Kricketune: {
    types: ['Bug'],
    bs: {hp: 80, at: 115, df: 70, sa: 40, sd: 70, sp: 65},
    weightkg: 25.5,
    abilities: {0: 'Swarm'},
  },
  Krilowatt: {
  ...
  Lickilicky: {
    types: ['Normal'],
    bs: {hp: 110, at: 100, df: 95, sa: 80, sd: 95, sp: 50},
    weightkg: 140,
    abilities: {0: 'Own Tempo'},
  },
  Lopunny: {
  ...
  'Porygon-Z': {
    types: ['Normal'],
    bs: {hp: 85, at: 76, df: 70, sa: 135, sd: 70, sp: 99},
    weightkg: 34,
    gender: 'N',
  ...
  Purugly: {
    types: ['Normal'],
    bs: {hp: 90, at: 95, df: 70, sa: 80, sd: 60, sp: 115},
    weightkg: 43.8,
    abilities: {0: 'Thick Fat'},
  },
  Pyroak: {
  ...
  Rampardos: {
    types: ['Rock'],
    bs: {hp: 97, at: 155, df: 90, sa: 35, sd: 90, sp: 33},
    weightkg: 102.5,
    abilities: {0: 'Mold Breaker'},
  },
  Rebble: {
  ...
  Shieldon: {
    types: ['Rock', 'Steel'],
    bs: {hp: 30, at: 22, df: 118, sa: 62, sd: 88, sp: 30},
    weightkg: 57,
    nfe: true,
    abilities: {0: 'Sturdy'},
  },
  ...
  Skuntank: {
    types: ['Poison', 'Dark'],
    bs: {hp: 115, at: 95, df: 70, sa: 71, sd: 60, sp: 85},
    weightkg: 38,
    abilities: {0: 'Stench'},
  },
  Snover: {
  ...
  Toxicroak: {
    types: ['Poison', 'Fighting'],
    bs: {hp: 83, at: 106, df: 65, sa: 86, sd: 65, sp: 98},
    weightkg: 44.4,
    abilities: {0: 'Anticipation'},
  },
  Turtwig: {
  ...
  Vespiquen: {
    types: ['Bug', 'Flying'],
    bs: {hp: 96, at: 80, df: 102, sa: 80, sd: 102, sp: 40},
    weightkg: 38.5,
    abilities: {0: 'Pressure'},
  },
  Voodoll: {
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Corsola: {bs: {hp: 65, df: 115, sd: 115}},
  ...
  Illumise: {bs: {df: 85, sd: 85}},
  Lunatone: {bs: {hp: 90}},
  Magcargo: {bs: {hp: 60, sa: 110}},
  Mantine: {bs: {hp: 85}},
